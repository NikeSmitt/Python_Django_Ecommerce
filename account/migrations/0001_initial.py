    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(blank=True, max_length=20, validators=[django.core.validators.RegexValidator(message='Phone number should be 5 - 11 numbers', regex='^\\d{5,11}$')])),
