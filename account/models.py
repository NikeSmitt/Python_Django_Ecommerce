...
class Customer(AbstractBaseUser, PermissionsMixin):
    ...
    mobile = models.CharField(max_length=20, blank=True, validators=[
        RegexValidator(regex='^\d{5,11}$', message=_('Phone number should be 5 - 11 numbers'))
    ])
